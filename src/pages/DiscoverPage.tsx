...
import { Search, BookOpen, ScrollText, Globe, ArrowRight, Sparkles, Calendar } from "lucide-react";
        ...
        <div className="relative flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          <div>
            <div className="mb-2 inline-flex items-center gap-2 rounded border border-accent/15 bg-background/70 px-2.5 py-1 text-small text-muted-foreground">
              <Globe className="h-3.5 w-3.5 text-accent" /> Community library
            </div>
            <h1 className="text-display text-foreground">Discover</h1>
            <p className="mt-1 max-w-2xl text-body text-muted-foreground">
              Explore public books shared by the community — read, learn and find new perspectives.
            </p>
          </div>
          <div className="grid grid-cols-2 gap-2 lg:min-w-[200px]">
            <div className="rounded border border-accent/15 bg-background/80 p-3">
              <p className="text-small text-muted-foreground">Public books</p>
      ...
      {isLoading ? (
        ...
        <div className="surface rounded border border-accent/15 py-16 flex flex-col items-center gap-3">
          <div className="w-12 h-12 rounded bg-accent/10 flex items-center justify-center">
            <Globe className="w-6 h-6 text-accent/50" />
          </div>
          <p className="text-body font-medium text-muted-foreground">No public books found</p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <span className="inline-flex items-center gap-1 text-[10px] font-medium text-success shrink-0 mt-0.5 border border-success/20 bg-success/8 px-1.5 py-0.5 rounded">
